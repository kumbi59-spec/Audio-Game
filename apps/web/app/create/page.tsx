...
function CreateCharacterPage() {
  ...
  const [selectedWorldClass, setSelectedWorldClass] = useState<string | null>(
    null,
  );
  ...
  useEffect(() => {
    if (!world) return;
    narrate(
      `Character creation for ${world.name}. Step 1: Enter your character's name.`,
    );
  }, [world, narrate]);
  ...
  function handleClassSelect(cls: CharacterClass) {
    ...
    narrate(
      `${info.name} selected. ${info.description}. Press Continue to proceed or choose a different class.`,
    );
  }
  ...
  function handleWorldClassSelect(cls: { name: string; description: string }) {
    ...
    narrate(
      `${cls.name} selected. ${cls.description}. Press Continue to proceed or choose a different class.`,
    );
  }

  function handleClassSubmit() {
    const displayClass =
      selectedWorldClass ?? CLASS_DESCRIPTIONS[selectedClass].name;
    narrate(
  ...
  async function handleStart(opts: { skipBackstory?: boolean } = {}) {
    ...
    setIsStarting(true);
    narrate(
      "Starting your adventure. The Game Master is preparing your world…",
    );
  ...
  return (
    <div className="min-h-screen surface-gradient">
      ...
      <div className="mx-auto max-w-lg px-4 py-8">
        ...
        {world && (
          <>
            <section className="surface-gradient inner-highlight mb-6 rounded-xl border border-border/70 p-4 shadow-sm">
              <Link
                href="/library"
            ...
            <section className="surface-gradient inner-highlight mb-6 rounded-xl border border-border/70 p-4">
              {/* Progress */}
              <div
                role="progressbar"
                aria-valuemin={1}
            ...
            <section className="surface-gradient inner-highlight mb-6 rounded-xl border border-border/70 p-4">
                ...
                <section aria-labelledby="step-class-heading">
                  ...
                  >
                    {world.classes && world.classes.length > 0
                      ...
                      : Object.entries(CLASS_DESCRIPTIONS).map(
                          ([cls, info]) => (
                            <button
                              key={cls}
                              type="button"
                              ...
                              onClick={() =>
                                handleClassSelect(cls as CharacterClass)
                              }
                            ...
                            >
                              ...
                              <div>
                                ...
                                <p className="mt-1 text-xs text-muted-foreground">
                                  HP: {info.startingStats.hp} · STR:{" "}
                                  {info.startingStats.strength} · DEX:{" "}
                                  {info.startingStats.dexterity} · INT:{" "}
                                  {info.startingStats.intelligence} · CHA:{" "}
              ...
              {step === "backstory" && (
                <section aria-labelledby="step-backstory-heading">
                  <h2
                    id="step-backstory-heading"
                    className="mb-4 text-lg font-semibold"
                  >
                    Step 3: Character details + backstory (optional)
                  </h2>
                  <p className="mb-4 text-sm text-muted-foreground">
                    Add a quick profile so the Game Master can address your
                  ...
                  <div className="mb-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
                    ...
                    <div className="sm:col-span-2">
                      <label
                        htmlFor="char-short-description"
                        className="mb-1 block text-sm font-medium"
                      >
                  ...
                  <p className="mb-4 text-sm text-muted-foreground">
                    Tell the Game Master about your character&apos;s past. This
                    shapes how NPCs and the world respond to you. You can skip
                    this step if you prefer to discover your story as you play.
                  </p>
                  <div className="mb-4">
                  ...
                  <div className="flex gap-3">
                    ...
                    >
                      {isStarting ? (
                        <span className="motion-loading">Starting…</span>
                      ) : (
                        "Begin Adventure →"
                      )}
                    </button>
            ...
            <section className="surface-gradient inner-highlight rounded-xl border border-border/60 bg-background/60 p-4">
