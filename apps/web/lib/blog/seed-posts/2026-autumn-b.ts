...
// Autumn 2026 daily series, part B: 4 Oct – 13 Oct.
export const AUTUMN_2026_B: ScheduledSeedPost[] = [
  {
...
**Premise:** A group of friends plays an old party game in front of a mirror.
...
**Premise:** An exclusive Halloween masquerade in an old manor. At midnight, the host asks everyone to unmask.
...
| | Audiobook | Audio drama / fiction podcast | Interactive audio story |
| --- | --- | --- | --- |
| Your role | Listener | Listener | Protagonist |
| Story | Fixed | Fixed | Changes with your choices |
| Length | Set | Episodic | As long as you play |
| Replay value | Same every time | Same every time | Different every time |
...
13. **The Village That Never Sleeps.** No one in the village has slept in three weeks. Something in their dreams is waiting.
...
Any of these works as a solo game. On EchoQuest:

1. Pick a world whose genre matches the idea
...
| --- | --- | --- | --- | --- |
| Harrowgate | Saint Vell | River path | 2 days | Low |
| Harrowgate | Brine | River barge | 1 day | Medium (smugglers) |
| Brine | The Fens | Causeway | Half a day | High (fog, bog lights) |
...
Ship battles can bog down in rules. In narrative and audio play, keep it cinematic:

1. **The approach:** do you chase, flee, or bluff with false colours?
2. **The broadside:** one or two exchanges of fire, described by effect
...
8. **The Plague Ship:** a drifting ship with full holds and no crew. Do you take the cargo?
